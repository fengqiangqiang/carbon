...
Read the design spec from `.Codex/scratch/research/[feature-name]-design.md`.
...
|-----------|-----------|----------------|
| Database migrations | `.Codex/rules/workflow-database-migration.md` | Multi-tenancy, RLS, id(), audit columns, indexes |
...
From `.Codex/rules/workflow-database-migration.md`:
...
Save to `.Codex/scratch/plans/[feature-name]-plan.md`:

```markdown
# [Feature] Implementation Plan

## Overview
- **Design Spec:** `.Codex/scratch/research/[feature-name]-design.md`
...
- [ ] Migration tasks follow `.Codex/rules/workflow-database-migration.md`
...
| Artifact | Location |
|----------|----------|
| Implementation plan | `.Codex/scratch/plans/[feature-name]-plan.md` |
