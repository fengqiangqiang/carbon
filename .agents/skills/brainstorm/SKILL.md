...
Save to `.Codex/scratch/research/[feature-slug].md`.
...
Save to `.Codex/scratch/research/[feature-name]-design.md`:
...
| Artifact | Location |
|----------|----------|
| Competitor research | `.Codex/scratch/research/[feature-slug].md` |
| Design specification | `.Codex/scratch/research/[feature-name]-design.md` |
