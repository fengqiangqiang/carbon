...
Read `.Codex/scratch/plans/[feature-name]-plan.md`.
...
Track progress in `.Codex/scratch/tasks/todo.md`:
...
|-----------|----------------|-----------|
| Database migrations | `.Codex/rules/workflow-database-migration.md` | Creating tables, columns, RLS |
...
**For migrations:** Read `.Codex/rules/workflow-database-migration.md` before writing SQL to ensure:
...
Update `.Codex/scratch/tasks/todo.md`:
```markdown
...
| Progress tracker | `.Codex/scratch/tasks/todo.md` |
| Commits | Git history |
