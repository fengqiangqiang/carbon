...
- Save to `.Codex/scratch/research/[feature].md`
...
- Save to `.Codex/scratch/research/[feature]-design.md`
...
- Save to `.Codex/scratch/plans/[feature]-plan.md`
- **Gate:** User approval required
...
[Saves to .Codex/scratch/research/lot-tracking.md]
...
|-------|----------|----------|
| Research | Competitor analysis | `.Codex/scratch/research/[feature].md` |
| Brainstorm | Design spec | `.Codex/scratch/research/[feature]-design.md` |
| Plan | Implementation plan | `.Codex/scratch/plans/[feature]-plan.md` |
