...
Save the research to `.Codex/scratch/research/[feature-slug].md` using the output format below.
...
See `.Codex/scratch/tasks/accrual-accounting-research.md` for an example of well-structured competitor research covering NetSuite and SAP accounting patterns.
